...
class Positional_history extends StatefulWidget {
  String? title;
  Positional_history({this.title});
  @override
  _Positional_historyState createState() => _Positional_historyState();
}

class _Positional_historyState extends State<Positional_history> {
  late ScrollController _scrollController;
  late Positional_history_data _apiService;

  @override
  void initState() {
    super.initState();
    _apiService = Provider.of<Positional_history_data>(context, listen: false);
      ...
      body: Stack(
        children: [
          ...
          ChangeNotifierProvider.value(
            value: _apiService,
            child: Consumer<Positional_history_data>(
  ...
  Widget _buildLoadingIndicator() {
    return Padding(
      ...
      child: Center(
        child: Provider.of<Positional_history_data>(context).hasMore
