...
class midterm_history extends StatefulWidget {
  String? title;
  midterm_history({this.title});
  @override
  _midterm_historyState createState() => _midterm_historyState();
}

class _midterm_historyState extends State<midterm_history> {
  late ScrollController _scrollController;
  late Midterm_history_data _apiService;

  @override
  void initState() {
    super.initState();
    _apiService = Provider.of<Midterm_history_data>(context, listen: false);
      ...
      body: Stack(
        children: [
          ...
          ChangeNotifierProvider.value(
            value: _apiService,
            child: Consumer<Midterm_history_data>(
  ...
  Widget _buildLoadingIndicator() {
    return Padding(
      ...
      child: Center(
        child: Provider.of<Short_history_data>(context).hasMore
