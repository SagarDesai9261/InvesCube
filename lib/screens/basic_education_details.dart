...
class Basic_Education_Details extends StatefulWidget {
  Basic_Education basic_education;
   Basic_Education_Details({Key? key,required this.basic_education}) : super(key: key);
  @override
  State<Basic_Education_Details> createState() => _Basic_Education_DetailsState();
}

class _Basic_Education_DetailsState extends State<Basic_Education_Details> {
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Html(data: widget.basic_education.description,
                  style: {
