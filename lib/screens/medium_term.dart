...
class mid_term_live_calls extends StatefulWidget {
  String? title;
  mid_term_live_calls({this.title});
  @override
  _mid_term_live_callsState createState() => _mid_term_live_callsState();
}

class _mid_term_live_callsState extends State<mid_term_live_calls> {
  late ScrollController _scrollController;
  late Midterm_data _apiService;

  @override
  void initState() {
    super.initState();
    _apiService = Provider.of<Midterm_data>(context, listen: false);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>midterm_history(title:"")));
              },
  ...
  Widget _buildLoadingIndicator() {
    return Padding(
      ...
      child: Center(
        child: Provider.of<Midterm_data>(context).hasMore
