...
void main() {
  runApp(positional_live_calls());
}

class positional_live_calls extends StatefulWidget {
  String? title;
  int? call_index;
  positional_live_calls({this.title,this.call_index});
  @override
  State<positional_live_calls> createState() => _positional_live_callsState();
}
...
class _positional_live_callsState extends State<positional_live_calls> {
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>Positional_history()));
                },
          ...
          children: <Widget>[
            ...
            SizedBox(
              ...
              child: FutureBuilder<List<DataList>>(
                  future: IpoDetailsService().getPostionalDetails(),
