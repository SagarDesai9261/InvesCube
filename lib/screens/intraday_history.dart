...
class Intraday_history extends StatefulWidget {
  String? title;
  Intraday_history({this.title});
  @override
  _Intraday_historyState createState() => _Intraday_historyState();
}

class _Intraday_historyState extends State<Intraday_history> {
  late ScrollController _scrollController;
  late Intraday_history_data _apiService;

  @override
  void initState() {
    super.initState();
    _apiService = Provider.of<Intraday_history_data>(context, listen: false);
      ...
      body: Stack(
        children: [
          ...
          ChangeNotifierProvider.value(
            value: _apiService,
            child: Consumer<Intraday_history_data>(
  ...
  Widget _buildLoadingIndicator() {
    return Padding(
      ...
      child: Center(
        child: Provider.of<Intraday_history_data>(context).hasMore
