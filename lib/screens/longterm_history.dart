...
class Longterm_history extends StatefulWidget {
  String? title;
  Longterm_history({this.title});
  @override
  _Longterm_historyState createState() => _Longterm_historyState();
}

class _Longterm_historyState extends State<Longterm_history> {
  late ScrollController _scrollController;
  late Longterm_history_data _apiService;

  @override
  void initState() {
    super.initState();

    _apiService = Provider.of<Longterm_history_data>(context, listen: false);
      ...
      body: Stack(
        children: [
          ...
          ChangeNotifierProvider.value(
            value: _apiService,
            child: Consumer<Longterm_history_data>(
  ...
  Widget _buildLoadingIndicator() {
    return Padding(
      ...
      child: Center(
        child: Provider.of<Longterm_history_data>(context).hasMore
