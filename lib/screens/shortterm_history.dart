...
class Short_history extends StatefulWidget {
  String? title;
  Short_history({this.title});
  @override
  _Short_historyState createState() => _Short_historyState();
}

class _Short_historyState extends State<Short_history> {
  late ScrollController _scrollController;
  late Short_history_data _apiService;

  @override
  void initState() {
    super.initState();
    _apiService = Provider.of<Short_history_data>(context, listen: false);
      ...
      body: Stack(
        children: [
          ...
          ChangeNotifierProvider.value(
            value: _apiService,
            child: Consumer<Short_history_data>(
