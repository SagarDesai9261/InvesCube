                      ...
                      children: [
                        ...
                        Stack(
                          children: [
                            Container(
                              ...
                              height: MediaQuery.of(context).size.width>400 ? 400 : 355,
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  begin: Alignment.topCenter,
                                  end: Alignment.bottomCenter,
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Container(
                                          height: 38,
                                          width:w > 500 ?  MediaQuery.of(context).size.width * .85:MediaQuery.of(context).size.width * .8 ,
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          child: Container(
                                            height: 38,
                                            width:w > 500 ?  MediaQuery.of(context).size.width * .44:MediaQuery.of(context).size.width * .43 ,
                                            decoration: ShapeDecoration(
                                              color: Colors.white,
                                        ...
                                        InkWell(
                                          ...
                                          child: Container(
                                            height: 38,
                                            width:w > 500 ?  MediaQuery.of(context).size.width * .44:MediaQuery.of(context).size.width * .42 ,
                                            decoration: ShapeDecoration(
                                              color: Colors.white,
                                              // color: Colors.white10,
                                              shape: RoundedRectangleBorder(
                                  ...
                                  Container(
                                    ...
                                    child: FutureBuilder<List<SliderData>>(
                                      future: Slider_data().fetchSliderData(), // Replace 1 with the actual category ID
                                      builder: (context, snapshot) {
                                        if (snapshot.connectionState ==
                                          ...
                                          List<SliderData> dataList = snapshot.data!;
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            width:w > 500 ?  MediaQuery.of(context).size.width * .28:MediaQuery.of(context).size.width * .27 ,
                                            height: 58,
                                            decoration: ShapeDecoration(
                                              color: Colors.white,
                                              shape: RoundedRectangleBorder(
                                        ...
                                        InkWell(
                                          ...
                                          child: Container(
                                            padding: EdgeInsets.only(top: 2),
                                            width:w > 500 ?  MediaQuery.of(context).size.width * .29:MediaQuery.of(context).size.width * .27 ,
                                            height: 58,
                                            decoration: ShapeDecoration(
                                              color: Colors.white,
                                              shape: RoundedRectangleBorder(
                        ...
                        Stack(
                          children: [
                            Container(
                                width: MediaQuery.of(context).size.width,
                                height: MediaQuery.of(context).size.width >400 ? 80:60,
                                decoration: BoxDecoration(
                                    gradient: LinearGradient(
                                      begin: Alignment.topCenter,
                                      end: Alignment.bottomCenter,
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>Ipo_allotment_status()));
                                      },
                                      child: Container(
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        height: 220, /*MediaQuery.of(context).size.height < 750
