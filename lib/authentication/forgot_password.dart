                  ...
                  InkWell(
                      onTap: () {
                        if (email.text.isEmpty || email.text == "") {
                          setState(() {
                            uemail = true;
                            email_message = "Mobile number is required";
                          });
                        } else if (uemail) {
                          setState(() {
                            uemail = false;
                        ...
                        if (email.text.length > 10 || email.text.length <10) {
                          setState(() {
                            uemail = true;
                            email_message = "Mobile number is invalid";
                          });
                        } else if (uemail) {
                          setState(() {
                            uemail = false;
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    //const SizedBox(height: 30),
                    Image.asset("assets/img_8.png", height: 180, width: 180),
                    SizedBox(
                      height: 30,
                    ),
                    const SizedBox(
                    ...
                    const Text(
                      'Enter the mobile no. to reset password here...',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 14,
                        fontFamily: 'Inter',
  ...
  Future<void> sendOtp() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (data['success'] == '1') {
        ...
        setState(() {
          uemail = true;
          email_message = "Mobile number is not Register";
        });
        // Handle error case
